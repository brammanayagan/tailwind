...
//                 <li>
//                   Work in event-based jobs like wedding photography assistance
//                   or event setup where payment is given per event.
//                 </li>
...
// export default FinancialStudentPage;
